...
public class FormComponentPanelPage extends BasePage
{
    ...
    public FormComponentPanelPage()
    {
        ...
        var groupsAndChoicesValues = new Label("groupsAndChoicesValues", groupsAndChoicesModel);
    ...
    private void addPaletteOnDescendents(Form<Object> form)
    {
        ...
        var descendentsValue = new Label("paletteDescendentsValue", descendentsModel.map(people -> people.stream().map(Person::getFullName).toList()));
    ...
    private void addPaletteOnPanel(Form<Object> form)
    {
        ...
        var panelValue = new Label("palettePanelValue", panelModel.map(people -> people.stream().map(Person::getFullName).toList()));
        panelValue.setOutputMarkupId(true);
