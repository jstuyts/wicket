 ...
 */
public class GuestBookPreact extends BasePage
{
	...
	public GuestBookPreact()
	{
        ...
        comments.add(new ListView<Comment>("comments",
		...
		commentForm.add(new AjaxFormSubmitBehavior(commentForm, "submit")
		{
			...
			protected void onSubmit(AjaxRequestTarget target)
			{
				...
				target.add(PreactReplacementEnablingBehavior.PREACT, comments);
	...
	private final class CommentForm extends Form<Comment>
	{
		...
		public void onSubmit()
		{
			...
			commentList.addFirst(newComment);
