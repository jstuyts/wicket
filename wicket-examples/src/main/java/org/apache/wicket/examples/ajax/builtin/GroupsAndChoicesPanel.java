...
public class GroupsAndChoicesPanel extends FormComponentPanel<GroupsAndChoicesValues>
{
    private CheckGroup<Integer> checkGroup =
            new CheckGroup<>("checkGroup", LambdaModel.of(getModel(), GroupsAndChoicesValues::getChecked, GroupsAndChoicesValues::setChecked));
    ...
    private RadioGroup<Integer> radioGroup =
            new RadioGroup<>("radioGroup", LambdaModel.of(getModel(), GroupsAndChoicesValues::getRadioed, GroupsAndChoicesValues::setRadioed));
