...
class ApacheLicenceHeaderTest extends ApacheLicenseHeaderTestCase
{
    ...
    ApacheLicenceHeaderTest()
	{
		...
		htmlIgnore.add("src/test/js/preact-replacement.html");
		...
		xmlPrologIgnore.add("src/test/js/preact-replacement.html");
		...
		javaScriptIgnore.add("src/main/java/org/apache/wicket/resource/preact");
