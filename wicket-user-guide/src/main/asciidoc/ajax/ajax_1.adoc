...
The replacement of markup can be extended with alternative methods. This is useful for when the jQuery markup replacement does not work properly, is too slow, and/or is missing features.
...
* When adding the component to the _AjaxRequestTarget_, specify the replacement method identifier. The identifier to use usually is a constant of the behavior registering the replacement method.
