...
public class XmlReplacementEnablingBehavior extends Behavior
{
     ...
     *
     * @param namepsaceUri the namespace URI of the element the component is attached to.
     */
    public XmlReplacementEnablingBehavior(String namepsaceUri)
    {
